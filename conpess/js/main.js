...
const messages = [
    "tap dimana ajwwa ywwaaa",
    "heyww kamwwu ❤️",
    "akwwu mwwau ngomong sesuatu nih",
    "coba pencwwet",
    "pencwwet lagi",
    "ayoww semangwwat mencetnya",
    "janjwwi ini terakhir",
    "ciusssww",
    "ini",
    "terakhir",
    "tapi bohong hehe yahaha hayyuk",
    "akuw tau pasti kamwwu kesal",
    "hmmmmzzzz",
    "yaudahw dehww",
    "padahwwal",
    "akuww cumwwa mau bilang",
    "kepasar beli terasi pulangnya makan kadal",
    "i love you pendekkww❤️",
    "dawgg u shoo cuteew",
    "coba pencwet tombol dibawah iniww 💝"
];
